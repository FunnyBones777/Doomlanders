...
function s.initial_effect(c)
	...
	c:RegisterEffect(e2)
	--Shuffle up to 3 of your DARK monsters from your GY or banishment into your Deck
...
function s.tdfilter(c)
	return c:IsAttribute(ATTRIBUTE_DARK) and c:IsFaceup() and c:IsAbleToDeck()
end
